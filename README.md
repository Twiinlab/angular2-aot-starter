...
Provides fast, reliable and extensible starter for the development of Angular projects base on [Minko Gechev Angular2 Seed](https://github.com/mgechev/angular-seed).

`angular2-aot-starter` provides the following features:
